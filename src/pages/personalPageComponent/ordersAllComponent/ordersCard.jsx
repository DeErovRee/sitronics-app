...
export const OrdersCard = ({ order, isProvider, context }) => {
    ...
    return (
        <Card>
            ...
            {order.providerNote && (
                <P>
                    <Span>Комментарий поставщика: </Span>
                    {order.providerNote}
                </P>
            )}
            {order.confirmationDate && (
                <P>
                    <Span>Дата принятия заказа: </Span>
                    <br />
                    {order.confirmationDate} {order.confirmationTime}
                </P>
            )}
            {order.providerDate && (
                <P>
                    <Span>
                        Ориентировочная дата выполнения заказа:
                        <br />{' '}
                    </Span>
                    {order.providerDate} {order.providerTime}
                </P>
            )}

            {order.orderStatus === 'На рассмотрении' && (
                <Status>
                    <Span>Статус: </Span>
                    <YellowStatus>{order.orderStatus}</YellowStatus>
                </Status>
            )}
            ...
            {order.orderStatus === 'Выполнена' && (
                <Status>
                    <Span>Статус: </Span>
                    <GreenStatus>{order.orderStatus}</GreenStatus>
                </Status>
            )}
            {order.orderStatus === 'Отменена' && (
                <Status>
                    <Span>Статус: </Span>
                    <RedStatus>{order.orderStatus}</RedStatus>
                </Status>
