    ...
    return (
        <>
            ...
            <Card>
                ...
                <p>В окне ниже введите текст, который будет отображаться на карточке поставщика услуг </p>
                <ReactQuill
                    value={text}
            ...
            <Card>
                ...
                <div className='images'>
                    {filesForView &&
                        filesForView.map((file) => {
                            return <img src={file} alt='' key={file} />
                        })}
                </div>

                <p>Выберите фото или видео-файлы, которые будут отображаться на карточке поставщика услуг.</p>
                <p>Новые файлы заменят собой старые</p>

                <input type='file' id='file' onChange={handleFiles} multiple='multiple' style={{ display: 'none' }} />
                        ...
                        files.map((file) => {
                            return (
                                <div className='preview-image' key={file.name}>
                                    <div className='preview-remove' data-name={file.name}>
                                        &times;
                                    </div>
                ...
                <CardButton onClick={deleteFiles}>Очистить</CardButton>
            </Card>
            <Card>
                ...
                <CardInput
                    ...
                    value={citysInput}
                    onChange={(e) => {
                        setCitysInput(e.target.value)
                    }}
                    placeholder='Поиск'
                />
                <Finded>
                    {citysFinded &&
                        citysFinded.map((city) => {
                            return (
                                <ItemFinded key={nanoid()}>
                                    <p onClick={(e) => handleCitys(e)}>
                                        {
                ...
                <CardButton onClick={deleteCitys}>Очистить</CardButton>
            </Card>
