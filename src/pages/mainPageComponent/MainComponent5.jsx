            ...
            <Container flexDirection={'column'} alignItems={'center'}>
                ...
                <Container>
                    <Card>
                        ...
                        <P>
                            Сотрудники центра досконально разбираются в беспилотных технологиях, поэтому могут
                            посоветовать оптимальную модель дрона, выполнить ремонт любой сложности и осуществить
                            съемку.
                        </P>
                    </Card>
                    <Card>
                ...
                <Container>
                    <Card>
                        ...
                        <P>
                            Индустрия беспилотных технологий очень динамична, и мы всегда в курсе новинок и
                            совершенствуем свои навыки, чтобы оправдывать ожидания клиентов.
                        </P>
                    </Card>
                    <Card>
                        <P margin={'0 0 20px 0'}>
                        ...
                        <P>
                            Как непосредственный партнер известных брендов-производителей центр может устанавливать
                            наиболее привлекательные цены, а стоимость услуг определяется в индивидуальном порядке.
                        </P>
                    </Card>
                </Container>
            </Container>
