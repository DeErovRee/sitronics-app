    ...
    return (
        <Content backgroundColor={'background-color: #1E1E1E'} padding={'77px 89px'}>
            <Container alignItems={'center'}>
                <H2 margin={'0 20px 0 0'}>о проекте</H2>
                <H5>
                    <TextDecor>Sitronics Drones</TextDecor> – инновационный проект, раскрывающий потенциал использования
                    беспилотных летательных аппаратов в самых разнообразных сферах деятельности.
                </H5>
            </Container>
        </Content>
    )
