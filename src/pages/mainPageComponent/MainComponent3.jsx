...
const Content = styled.div`
    ...
    @media${(props) => props.theme.media.tablet} {
        ...
        background-image: ${(props) => props.backgroundColor || props.theme.colors.gradient};
    }
`
        ...
        <Content img={require('../../images/Sitronics-1.png')} padding={'108px 89px 343px'}>
            <ContainerFlex>
                <Container flexDirection={'column'} margin={'0 60px 0 0'}>
                    ...
                    <P>
                        Мы в равной степени ориентированы на профессионалов и новичков, только открывающих для себя и
                        своего бизнеса мир беспилотных технологий.
                    </P>
                </Container>
