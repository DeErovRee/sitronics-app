    ...
    return (
        <LoginStyled>
            <Form id='form' onSubmit={handleSubmit}>
                ...
                <Input type='email' placeholder='Введите свой email' value={email} onChange={handleEmailChange} />
                <Input type='password' placeholder='Введите свой пароль' value={password} onChange={handlePassChange} />
                {error && <Error>{error}</Error>}
                <Button type='submit'>Войти</Button>
                <Container>
                    <P color={'#000842'} cursor={'pointer'} onClick={handleForgotPassword}>
                        Не помню пароль
                    </P>
                    <P color={'#000842'} cursor={'pointer'}>
