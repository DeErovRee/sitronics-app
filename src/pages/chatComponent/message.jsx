...
export const Message = ({ message }) => {
    ...
    return (
        <MessageStyled status={message.sendId === currentUser.uid && 'owner'} ref={ref}>
            <MessageInfo>
                <UserImg src={message.sendId === currentUser.uid ? currentUser.photoURL : data.user.photoURL} alt='' />
                <span>date</span>
            </MessageInfo>
            <MessageContent>
