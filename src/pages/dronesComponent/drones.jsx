...
const DronesArr = [
    {
        ...
        description:
            'Идеально подходит для транспортировки посылок, медикаментов, продуктов питания или других товаров',
    ...
    },
    {
        ...
        description:
            'Дроны с тепловизионными камерами и ночным видением для поисково-спасательных работ, проверки линий электропередач, мониторинга дикой территории и прочих задач, проходящих в темное время суток.',
        advantages: [
    ...
    },
    {
        ...
        description:
            'Сельскохозяйственные дроны для опрыскивания и посева. Автоматизируют и оптимизируют работу, контроль культур в режиме 24/7',
        advantages: [
    ...
    },
    {
        ...
        description:
            'Дрон-обнаружитель пожаров для быстрого обнаружения возгораний и предотвращения распространения огня',
        advantages: [
            'Обследование огромных территорий',
            'Полеты над труднодоступными территориями',
            'Выявление скрытых очагов возгорания',
            'Работа в ночное время',
        ],
    },
    {
        ...
        advantages: [
            ...
            'Улучшение качества картогрфических продуктов',
            'Работа в ночное время',
        ],
    },
    {
        ...
        advantages: [
            'Сокращение времени и затрат на учет',
            'Увеличение эффективности учета животных',
            'Возможность отслеживания миграции',
            'Получение данных из труднодоступных мест',
        ],
    },
]
