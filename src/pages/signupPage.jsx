    ...
    return (
        <LoginStyled>
            <Form onSubmit={handleSubmit} id='form'>
                ...
                <Input type='name' placeholder='Введите имя' onChange={handleNameChange} value={displayName} />
                <Input type='email' placeholder='Введите свой email' onChange={handleEmailChange} value={email} />
                <Input type='password' placeholder='Введите пароль' onChange={handlePassChange} value={password} />
                <Input
                    type='password'
                ...
                <Label>
                    <Checkbox type='checkbox' id='provider' onChange={handleIsProviderChange} />Я поставщик услуг
                </Label>
