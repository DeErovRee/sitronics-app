                        ...
                        <ListItem textTransform={'uppercase'}>
                            <ListImg height={'15px'}>
                                <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.1875 0.5V2H12.2366L0.3125 14.4425L1.32594 15.5L13.25 3.0575V12.5H14.6875V0.5H3.1875Z" fill="white"/>
                                </svg>
                            </ListImg>
                            <p>vk</p>
                        </ListItem>
                        ...
                        <ListItem>
                            <ListImg width={'20px'}>
                                <svg width="18" height="24" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.99992 0.333252C4.48492 0.333252 0.833252 3.98492 0.833252 8.49992C0.833252 14.6249 8.99992 23.6666 8.99992 23.6666C8.99992 23.6666 17.1666 14.6249 17.1666 8.49992C17.1666 3.98492 13.5149 0.333252 8.99992 0.333252ZM3.16659 8.49992C3.16659 5.27992 5.77992 2.66659 8.99992 2.66659C12.2199 2.66659 14.8333 5.27992 14.8333 8.49992C14.8333 11.8599 11.4733 16.8883 8.99992 20.0266C6.57325 16.9116 3.16659 11.8249 3.16659 8.49992Z" fill="white"/>
                                </svg>
                            </ListImg>
